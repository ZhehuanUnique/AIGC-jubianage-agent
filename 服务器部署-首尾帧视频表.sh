...
# 服务器部署脚本：包含数据库迁移
# 注意：数据库迁移需要在Supabase SQL编辑器中手动执行 migrate_first_last_frame_videos.sql
...
echo "=========================================="
echo ""
echo "⚠️  重要：请记得在Supabase SQL编辑器中执行数据库迁移脚本："
echo "   server/db/migrate_first_last_frame_videos.sql"
echo ""
