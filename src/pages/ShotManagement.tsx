                ...
                >
                  {!shot.isExpanded ? (
                    ...
                    <div className="flex items-center gap-4">
                      {/* 左侧：图片缩略图 */}
                      <div className="w-24 h-16 bg-[#0a0a0a] rounded border border-gray-700 flex-shrink-0 flex items-center justify-center overflow-hidden">
                        {shot.thumbnailImage ? (
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-4 mb-2">
                          ...
                          <span className="text-purple-400 text-sm relative group cursor-pointer">
                            ...
                            <span className="absolute left-0 top-full mt-2 w-96 p-3 bg-[#0a0a0a] border border-gray-700 rounded-lg shadow-lg z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all text-xs text-white whitespace-pre-wrap break-words">
                              {shot.prompt}
                            </span>
                          </span>
                        </div>
                      ...
                      {/* 右侧：模型、数量、分镜描述信息块 */}
                      <div className="bg-[#0a0a0a] border border-gray-700 rounded-lg p-3 flex-shrink-0 min-w-[200px]">
                        <div className="mb-2">
                        ...
                        <div>
                          <span className="text-xs text-gray-400">分镜描述:</span>
                          <p className="mt-1 text-xs text-gray-300 line-clamp-2">{shot.description}</p>
                        </div>
                      </div>
                ...
                <div className="p-6 border-t border-gray-800">
                  <div className="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-2 bg-[#0a0a0a] border border-gray-700 rounded-lg focus:outline-none focus:border-purple-500 resize-none text-sm text-gray-300"
                          rows={8}
                      ...
                      <div>
                        ...
                        <div className="px-4 py-3 bg-[#0a0a0a] border border-gray-700 rounded-lg text-sm text-gray-300 whitespace-pre-wrap max-h-48 overflow-y-auto">
                          {shot.segment || '暂无对应片段'}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-[#0a0a0a] border border-gray-700 rounded-lg p-4">
                        ...
                        <div>
                          <span className="text-sm text-gray-400">分镜描述:</span>
                          <p className="mt-1 text-sm text-gray-300">{shot.description || '暂无描述'}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 flex-wrap">
                      {shot.associatedCharacters.map((char, idx) => (
                        <div
                          key={idx}
                          className="relative w-20 h-20 bg-[#0a0a0a] border border-gray-700 rounded"
                        >
                      ...
                      <button className="w-20 h-20 bg-[#0a0a0a] border border-gray-700 rounded flex items-center justify-center hover:border-purple-500">
                        <div className="text-center">
                          <Plus size={20} className="mx-auto mb-1 text-gray-400" />
                          <span className="text-gray-400 text-xs">新增</span>
                        </div>
                      </button>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <button className="w-20 h-20 bg-[#0a0a0a] border border-gray-700 rounded flex items-center justify-center hover:border-purple-500">
                      <div className="text-center">
                        <Plus size={20} className="mx-auto mb-1 text-gray-400" />
                        <span className="text-gray-400 text-xs">选择并编辑上传</span>
                      </div>
                    </button>
                  </div>
                    ...
                    <div className="flex gap-2">
                      {shot.associatedScenes.map((scene, idx) => (
                        <div
                          ...
                          className="relative w-20 h-20 bg-[#0a0a0a] border border-gray-700 rounded"
                        >
                          <button className="absolute -top-2 -right-2 w-5 h-5 bg-pink-500 rounded-full flex items-center justify-center text-white text-xs">
                            ×
                          </button>
                        </div>
                      ))}
