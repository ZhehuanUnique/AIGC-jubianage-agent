...
const packages: RechargePackage[] = [
  { credits: 5000, value: 1000, price: 1000 },
  { credits: 15000, value: 3000, price: 3000 },
  { credits: 25000, value: 5000, price: 5000 },
  { credits: 50000, value: 10000, price: 10000 },
]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg">巨日禄是一款专制作商业化级别剧作工具</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {/* 左侧 - 选择充值套餐 */}
          <div>
            <h2 className="text-2xl font-semibold mb-6 text-purple-400">选择充值套餐</h2>
                ...
                >
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <div className="text-sm text-gray-400">价值 ¥{pkg.value.toLocaleString()}</div>
                    </div>
          ...
          {/* 右侧 - 支付信息 */}
          <div>
            <h2 className="text-2xl font-semibold mb-6 text-purple-400">支付信息</h2>
            <div className="bg-gray-800 rounded-lg p-8 border-2 border-dashed border-purple-500 min-h-[400px] flex flex-col items-center justify-center">
              {selectedPackage ? (
                <div className="w-full">
                  <div className="text-center mb-8">
                    <div className="text-6xl font-bold text-purple-500 mb-4">¥{selectedPackage.price.toLocaleString()}</div>
                    <div className="text-xl text-gray-300 mb-2">{selectedPackage.credits.toLocaleString()} 积分</div>
                    <div className="text-sm text-gray-400">价值 ¥{selectedPackage.value.toLocaleString()}</div>
                  </div>
                  <button
                ...
                <div className="text-center">
                  <div className="text-6xl font-bold text-gray-600 mb-6">¥</div>
                  <div className="text-xl text-gray-400 mb-2">选择充值套餐</div>
        ...
        <div className="bg-gray-900 rounded-lg p-6 border border-gray-700">
          <h3 className="text-xl font-semibold mb-4 text-purple-400">支付协议</h3>
          ...
          <div className="mt-4 flex items-center justify-between">
            <span className="text-gray-400 text-sm">点击充值即表示同意</span>
            <a
              href="#"
