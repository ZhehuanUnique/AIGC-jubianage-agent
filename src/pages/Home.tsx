        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-8 px-4 py-8 relative z-10">
          ...
          <div className="flex flex-col items-center gap-4 bg-transparent w-full max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 bg-transparent w-full">
              ...
              <button
                onClick={handleClick}
                className="uiverse-button-card px-8 md:px-10 py-6 md:py-7 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-2xl hover:shadow-purple-500/50 relative z-20 transform hover:scale-105 overflow-hidden"
              >
                <div className="uiverse-loader">
                  <div className="uiverse-words">
                    {buttonTexts.map((text, index) => (
                      <span key={index} className="uiverse-word">
                        {text}
                      </span>
                    ))}
                  </div>
