...
# 使用方法: bash 更新Hailuo-API密钥.sh

echo "=========================================="
echo "  更新服务器端 Hailuo API Key"
echo "=========================================="
...
echo "=========================================="
echo ""
echo "⚠️  请手动执行以下命令重启后端服务："
echo "   ssh ${SERVER_USER}@${SERVER_HOST} 'cd ${SERVER_PATH} && pm2 restart aigc-agent'"
